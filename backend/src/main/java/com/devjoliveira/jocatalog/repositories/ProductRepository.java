...
public interface ProductRepository extends JpaRepository<Product, Long> {
  ...
  @Query("SELECT obj FROM Product obj JOIN FETCH obj.categories WHERE obj.id IN :categoryIds")
  List<Product> searchProductsWithCategories(List<Long> categoryIds);
